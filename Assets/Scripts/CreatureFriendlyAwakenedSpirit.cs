...
public class CreatureFriendlyAwakenedSpirit : CreatureEnemy
{
    ...
    public override void PlayIdleAnimation()
    {
        ...
        {
            animator.Play("ghost_idle_right");
        }
        if (facingDirection == FacingDirection.Left)
        {
            animator.Play("ghost_idle_left");
        }
        if (facingDirection == FacingDirection.Up)
        {
            animator.Play("ghost_idle_up");
        }
        if (facingDirection == FacingDirection.Down)
        {
            animator.Play("ghost_idle_down");
        }
    }
    public override void PlayWalkAnimation()
    {
        if (facingDirection == FacingDirection.Right)
        {
            animator.Play("ghost_walk_right");
        }
        if (facingDirection == FacingDirection.Left)
        {
            animator.Play("ghost_walk_left");
        }
        if (facingDirection == FacingDirection.Up)
        {
            animator.Play("ghost_walk_up");
        }
        if (facingDirection == FacingDirection.Down)
        {
            animator.Play("ghost_walk_down");
        }
    }
    public override void PlayAttackAnimation()
    {
        if (facingDirection == FacingDirection.Left)
        {
            animator.Play("ghost_attack_left");
        }
        if (facingDirection == FacingDirection.Right)
        {
            animator.Play("ghost_attack_right");
        }
        if (facingDirection == FacingDirection.Up)
        {
            animator.Play("ghost_attack_up");
        }
        if (facingDirection == FacingDirection.Down)
        {
            animator.Play("ghost_attack_down");
        }
    }
    public override void PlayDeathAnimation()
    {
        if (facingDirection == FacingDirection.Left)
        {
            animator.Play("ghost_death_left");
        }
        if (facingDirection == FacingDirection.Right)
        {
            animator.Play("ghost_death_right");
        }
        if (facingDirection == FacingDirection.Up)
        {
            animator.Play("ghost_death_up");
        }
        if (facingDirection == FacingDirection.Down)
        {
            animator.Play("ghost_death_down");
        }
    }
